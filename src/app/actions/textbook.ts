...
/**
 * Record that a user passed a chapter Knowledge Check. This advances the
 * textbook MILESTONE certificate (earned only after every chapter quiz is
 * passed AND the final master exam is passed). Individual chapter quizzes earn
 * a badge / activity report, not a certificate — generated by the quiz engine
 * via the activity-reports service.
 */
