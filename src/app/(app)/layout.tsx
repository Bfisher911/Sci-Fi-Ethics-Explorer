...
import { AppShellSkeleton } from '@/components/loading/page-skeleton';
  ...
  if (!user && publicPath) {
    return (
      <div className="flex flex-col min-h-screen bg-background">
        ...
        {/* Intentional in-shell footer — NOT a duplicate of the global
            <SiteFooter />. This slim anonymous shell pins a conversion CTA
            (free reading → subscribe) to the bottom of the first screenful;
            the global SiteFooter (nav + legal + site copyright) still renders
            below it from the root layout. Distinct purpose and content, so it
            stays. */}
